...
using ConsoleApp06.Models;
using Microsoft.EntityFrameworkCore;

namespace ConsoleApp06.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=pubs;User Id=sa;Password=YourStrong@Passw0rd;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.Job).WithMany(p => p.Employees)
                ...
                .HasConstraintName("FK__employee__job_id__5812160E");

            entity.HasOne(d => d.Pub).WithMany(p => p.Employees)
                .HasForeignKey(d => d.PubId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__employee__pub_id__5AEE82B9");
        });

        modelBuilder.Entity<Job>(entity =>
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A599613893");
        ...
        modelBuilder.Entity<PubInfo>(entity =>
        {
            ...
            entity.HasOne(d => d.Pub).WithOne(p => p.PubInfo)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__pub_info__pub_id__534D60F1");
        });
